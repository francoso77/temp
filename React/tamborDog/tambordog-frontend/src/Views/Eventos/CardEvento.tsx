...
export default function CardEvento({
  ...
  return (
    <>
      <Card onClick={onClickCard} sx={{ display: "flex", margin: 1.5 }}>
        <Grid container>
          <Grid item >
            <CardMedia
              component="img"
          ...
          <Grid item >
            <Grid item container direction='column' >
              <Grid item xs>
                ...
                <Typography variant="caption" display="block" gutterBottom sx={{ marginLeft: '5px' }}>
                  {cidade} - {uf} - {data}
                </Typography>
              </Grid>
              <Grid item container direction='column' >
                <Grid item sx={{ display: 'flex', alignContent: 'center', marginLeft: '5px' }}>
