...
import { Box, Typography, Container, Button, Paper, Grid, IconButton } from '@mui/material';
...
export default function Funcionario() {
  ...
  const Cabecalho: Array<DataTableCabecalhoInterface> = [
    ...
    },
    {
      ...
      cabecalho: 'CPF',
      alinhamento: 'left',
      format: (v: string) => { return v.replace(/(\d{3})(\d{3})(\d{3})(\d{2})/, '$1.$2.$3-$4') }
      // format: (v: string) => { return `${v.substring(0, 3)}.${v.substring(3, 6)}.${v.substring(6, 9)}-${v.substring(9, 11)}` }
