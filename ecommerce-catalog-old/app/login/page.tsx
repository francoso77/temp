...
export default function LoginPage() {
  ...
  const handleCustomerLogin = async (e: React.FormEvent) => {
    ...
    setLoading(true)
    try {
      await login(customerData.email)
      router.push("/")
    } catch (error) {
  ...
  const handleVendorLogin = async (e: React.FormEvent) => {
    ...
    setLoading(true)
    try {
      await login(vendorData.email, vendorData.senha)
          ...
          <CardContent>
            <Tabs value={activeTab} onValueChange={setActiveTab}>
              <TabsList className="grid w-full grid-cols-2">
                ...
                <TabsTrigger value="vendor">Representante</TabsTrigger>
              </TabsList>
              ...
              <TabsContent value="vendor" className="space-y-4 mt-6">
                <div className="text-center mb-4">
                  ...
                  <h3 className="font-semibold text-foreground">Área do Representante</h3>
                ...
                <form onSubmit={handleVendorLogin} className="space-y-4">
                  ...
                  <Button type="submit" className="w-full" disabled={loading}>
                    {loading ? "Entrando..." : "Entrar como Representante"}
                  </Button>
                </form>
