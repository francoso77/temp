...
export default function NewClientPage() {
  ...
  const dataDate = formData.dataCadastro
    ? parse(formData.dataCadastro, "dd/MM/yyyy", new Date())
    : undefined;
      ...
      <div className="flex">
        ...
        <main className="flex-1 p-6">
          ...
          <div className="mb-8">
            ...
            <p className="text-muted-foreground">Adicione um novo cliente em sua carteira</p>
          </div>
                    ...
                    <Popover>
                      <PopoverTrigger asChild>
                        ...
                        >
                          ...
                          {/* Agora formatamos o objeto Date convertido (dataDate) */}
                      ...
                      <PopoverContent className="w-auto p-0" align="start">
                        <Calendar
                          mode="single"
                          // Passamos o objeto Date convertido para o Calendar
                          selected={dataDate}
                          onSelect={(date) => {
                            // Ao selecionar, convertemos o objeto Date de volta para String antes de atualizar o formData
                            if (date) {
                              handleInputChange("dataCadastro", format(date, "dd/MM/yyyy"));
                            } else {
