...
var ClsLoginUsuarioController = /** @class */ (function () {
    ...
    ClsLoginUsuarioController.prototype.logar = function (email_1, senha_1) {
        return __awaiter(this, arguments, void 0, function (email, senha, tipo) {
            var retorno, usuario, senhaValida, token, cliente, token;
            if (tipo === void 0) { tipo = 'cliente'; }
            return __generator(this, function (_a) {
                switch (_a.label) {
                    case 0:
                        retorno = {
                        ...
                        if (!(tipo === 'vendedor')) return [3 /*break*/, 7];
                    ...
                    case 2:
                        senhaValida = _a.sent();
                        if (!!senhaValida) return [3 /*break*/, 4];
                    ...
                    case 7: return [4 /*yield*/, data_source_1.AppDataSource.getRepository(cliente_1.default).findOne({
                            where: { email: email }
                        })];
                    case 8:
                        cliente = _a.sent();
