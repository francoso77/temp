...
var UserController = /** @class */ (function () {
   ...
   */
        ...
        return __awaiter(this, void 0, void 0, function () {
            ...
            return __generator(this, function (_a) {
                switch (_a.label) {
                    case 0:
                        _a.trys.push([0, 2, , 3]);
                        return [4 /*yield*/, this.userService.createUser(userData)];
                    case 1:
                        user = _a.sent();
                        return [2 /*return*/, user]; // Retorna o usuário criado (sem a senha, idealmente, se for uma prática segura)
                    case 2:
                        error_3 = _a.sent();
                        ...
                        if (error_3.code === '23505') { // Exemplo para erro de violação de unique constraint no PostgreSQL
                            throw new common_1.BadRequestException('Usuário com este e-mail ou CNPJ já existe.');
                        }
                        throw new common_1.InternalServerErrorException('Não foi possível criar o usuário. Usuário com este e-mail ou CNPJ já existe.');
                    case 3: return [2 /*return*/];
                }
            });
        });
    ...
    __decorate([
        ...
        (0, common_1.UseInterceptors)((0, platform_express_1.FilesInterceptor)('data')),
