...
export default function DashboardPage() {
      ...
      const mockOrders: Pedido[] = [
        {
          ...
          total: "R$ 2.799,98",
          status: "pendente",
          //cliente: { id: "1", nome: "João Silva", email: "joao@email.com" },
        },
        {
          id: "2",
          idCliente: "2",
          ...
          total: "R$ 1.299,99",
          status: "em_analise",
          //cliente: { id: "2", nome: "Maria Santos", email: "maria@email.com" },
        },
        {
          id: "3",
          idCliente: "3",
          ...
          total: "R$ 899,99",
          status: "aprovado",
          //cliente: { id: "3", nome: "Pedro Costa", email: "pedro@email.com" },
        },
        {
          id: "4",
          idCliente: "4",
          ...
          total: "R$ 3.499,99",
          status: "em_separacao",
          //cliente: { id: "4", nome: "Ana Oliveira", email: "ana@email.com" },
        },
        {
          id: "5",
          idCliente: "5",
          ...
          total: "R$ 599,99",
          status: "enviado",
          //cliente: { id: "5", nome: "Carlos Lima", email: "carlos@email.com" },
        },
      ]
  ...
  // Calculate metrics
  const totalRevenue = recentOrders.reduce((sum, order) => sum + parseBRL(order.total), 0)
  const averageOrderValue = totalRevenue / (recentOrders.length || 1)
