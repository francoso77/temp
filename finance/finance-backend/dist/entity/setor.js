...
var Setor = /** @class */ (function () {
    ...
    __decorate([
        ...
        __metadata("design:type", String)
    ], Setor.prototype, "name", void 0);
    __decorate([
        (0, typeorm_1.CreateDateColumn)({ name: 'createdAt', type: 'timestamp', nullable: false }),
        __metadata("design:type", Date)
    ], Setor.prototype, "createAt", void 0);
    __decorate([
        (0, typeorm_1.UpdateDateColumn)({ name: 'updatedAt', type: 'timestamp', nullable: false }),
        __metadata("design:type", Date)
    ], Setor.prototype, "updateAt", void 0);
    __decorate([
        (0, typeorm_1.Column)({ nullable: true }),
        __metadata("design:type", String)
    ], Setor.prototype, "userId", void 0);
    __decorate([
        (0, typeorm_1.JoinColumn)({ name: 'userId' }),
        (0, typeorm_1.ManyToOne)(function () { return user_1.User; }),
        __metadata("design:type", user_1.User)
    ], Setor.prototype, "user", void 0);
    Setor = __decorate([
        (0, typeorm_1.Index)(['name'], { unique: true }),
        (0, typeorm_1.Entity)({ name: 'setores' })
    ], Setor);
    return Setor;
}());
