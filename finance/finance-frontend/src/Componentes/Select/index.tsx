...
interface PropsInputInterface {
  ...
  nomeCampoDescricaoOpcoes1: string
  nomeCampoDescricaoOpcoes2: string
}
...
export default function InputSelect({
  ...
  nomeCampoDescricaoOpcoes1,
  nomeCampoDescricaoOpcoes2,
}: PropsInputInterface) {
  return (
    <>
        ...
        >
          {opcoes.map((v, indice) => (
            <MenuItem key={indice} value={v[nomeCampoChaveOpcoes]}>
              {v[nomeCampoDescricaoOpcoes1]} {v[nomeCampoDescricaoOpcoes2]}
            </MenuItem>
          ))}
        </Select>
