...
var OutController = /** @class */ (function () {
    ...
    OutController.prototype.programacaoPedidos = function (itemPesquisa) {
        return __awaiter(this, void 0, void 0, function () {
            var sql, dataParam;
            return __generator(this, function (_a) {
                sql = "\n    SELECT \n      pd.idProgramacaoDublagem,\n      pd.dataProgramacao,\n      pd.qtdCola,\n      pd.qtdFilme,\n      IFNULL(SUM(dp.qtdPedida), 0) AS metros\n    FROM \n      programacaodublagens pd\n    LEFT JOIN\n      detalheprogramacaodublagens dpd ON dpd.idProgramacaoDublagem = pd.idProgramacaoDublagem\n    LEFT JOIN \n      pedidos p ON p.idPedido = dpd.idPedido\n    LEFT JOIN\n      detalhepedidos dp ON dp.idPedido = p.idPedido\n    WHERE\n      (? IS NULL OR pd.dataProgramacao = ?)\n    GROUP BY\n      pd.idProgramacaoDublagem,\n      pd.dataProgramacao,\n      pd.qtdCola,\n      pd.qtdFilme;\n  ";
                dataParam = (itemPesquisa === null || itemPesquisa === void 0 ? void 0 : itemPesquisa.trim()) || null;
                return [2 /*return*/, data_source_1.AppDataSource.getRepository(programacaoDublagem_entity_1.default).query(sql, [dataParam, dataParam])];
            });
        });
    };
