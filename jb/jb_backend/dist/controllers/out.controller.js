...
var OutController = /** @class */ (function () {
    ...
    OutController.prototype.pedidosEmAberto = function () {
        return __awaiter(this, void 0, void 0, function () {
            return __generator(this, function (_a) {
                return [2 /*return*/, data_source_1.AppDataSource.getRepository(pedido_entity_1.default).find({
                        where: { statusPedido: statusPedidoTypes_1.StatusPedidoType.aberto }
                    })];
            });
        });
    };
    __decorate([
        (0, common_1.Get)("pedidosEmAberto"),
