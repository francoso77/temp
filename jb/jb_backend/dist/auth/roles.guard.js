...
var RolesGuard = /** @class */ (function () {
    ...
    RolesGuard.prototype.canActivate = function (context) {
        return __awaiter(this, void 0, void 0, function () {
            var requiredRoles, usuarioAtual, acesso, acessos;
            return __generator(this, function (_a) {
                switch (_a.label) {
                    case 0:
                        ...
                        acesso = new acesso_cls_1.default();
                        return [4 /*yield*/, Promise.all(requiredRoles.map(function (role) { return acesso.checarAcesso(usuarioAtual, role.modulo, role.permissao); }))];
                    case 1:
                        acessos = _a.sent();
                        // Retorna true se qualquer validação for bem-sucedida
                        return [2 /*return*/, acessos.some(Boolean)];
                }
            });
        });
    };
