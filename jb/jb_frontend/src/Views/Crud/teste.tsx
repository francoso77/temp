import { Autocomplete, Box, Container, Dialog, FormControl, Grid, IconButton, InputLabel, OutlinedInput, Paper, Select, Tooltip, Typography } from '@mui/material';
...
export default function TesteHook({ rsEstrutura }: PropsInterface) {
